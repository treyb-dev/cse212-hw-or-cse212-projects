...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The actual result is also different from what was expected.
    ...
    // Defect(s) Found: The actual result was not equal to the Expected result in this case.
